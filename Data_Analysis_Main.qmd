...
-   Leaf water potential ($LWP$) was recorded with psychrometers (`PSY` column).

-   Soil water potential ($SWP$) was recorded with TEROS 21 (`Teros` column).

-   Weight ($W$) was recorded with scales (`Scale` column).
