...
The repository contains the following folders : \* data/ : \* raw/ contains one folder per variable.
Inside each subfolder are stored raw files directly collected from sensors.
Typically, each file corresponds to one plant.
